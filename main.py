...
def search():
    ...
    if response.status_code==200: #200 means request was successfull, 404 means not found, 401 means unauthorized
        data=response.json()
...
#Book Title
text={'a1':Label(frame1,text="Book Title",font=("aerial",10),fg="green"),'a2':Label(frame2,text="Book Title",font=("aerial",10),fg="green"),'a3':Label(frame3,text="Book Title",font=("aerial",10),fg="green"),'a4':Label(frame4,text="Book Title",font=("aerial",10),fg="green"),'a5':Label(frame5,text="Book Title",font=("aerial",10),fg="green")}
